...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/macbook/Documents/GitHub/nova-cpc/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/macbook/Documents/GitHub/nova-cpc/public/storage','logging.default',
...
'permission.register_permission_check_method','permission.register_octane_reset_listener','permission.teams','permission.team_resolver','permission.use_passport_client_credentials',
...
'cors.supports_credentials','laravel-impersonate.session_key','laravel-impersonate.session_guard','laravel-impersonate.session_guard_using','laravel-impersonate.default_impersonator_guard',
...
'signed','throttle','verified','checkPermissions',);
        registerArgumentsSet('routes', 
'livewire.update','livewire.upload-file','livewire.preview-file',
'ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','profile.edit',
'profile.update','profile.destroy','users.index','users.create','users.store',
'users.show','users.update','users.destroy','roles.index','roles.create',
'roles.store','roles.show','roles.update','roles.destroy','permissions.index',
'permissions.show','dashboard','dashboard','quick-insights.index',
'budget-monitoring','reports.index','reports.store','performance.google-ads','performance.meta-ads',
'performance.tiktok-ads','performance.ga4','performance.gsc','products.index','products.create',
'products.store','products.show','products.update','products.destroy','feed-management.index',
'feed-management.import','feed-management.fetch','feed-management.export','feed-management.export-options','feed-management.update-export-options',
'feed-management.labeling-dashboard','feed-management.analyze-labels','profitability.index','profitability.analyze','labeling-rules.index',
'labeling-rules.store','labeling-rules.destroy','ppc-insights.index','ppc-insights.fetch','setup.index',
'setup.init-auth','setup.auth-callback','setup.remove-account','setup.import-xml','setup.add-website',
'setup.remove-website','register','login',
...
'app','applications.analytics','applications.calendar','applications.datatables','applications.kanban',
'applications.wizard','auth.login','auth.register','auththem.error.404','auththem.error.500',
'auththem.lock.basic','auththem.lock.cover','auththem.lock.illustration','auththem.reset.basic','auththem.reset.cover',
'auththem.reset.illustration','auththem.verification.basic','auththem.verification.cover','auththem.verification.illustration','budget-monitoring.index',
...
'components.fixed-plugins','components.input-error','components.input-label','components.modal','components.nav-link',
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.setup.add-website','components.setup.steps',
'components.sidebar','components.sidebar.account-management','components.sidebar.admin-menu','components.sidebar.feed-management','components.sidebar.general-management',
'components.sidebar.performance','components.sidebar.products-management','components.text-input','dashboard','dashboard.overview',
'emails.report','errors.403','errors.404','errors.500','feed-management.analytics',
'feed-management.export','feed-management.export-options','feed-management.export-template','feed-management.import','feed-management.index',
'feed-management.labeling-dashboard','feed-management.labeling-rules','layouts.app','layouts.footers.auth.footer','layouts.footers.guest.footer',
'layouts.navbars.auth.nav','layouts.navbars.auth.nav-auth-basic','layouts.navbars.auth.nav-auth-cover','layouts.navbars.auth.sidebar','layouts.navbars.guest.nav',
'pages.account.billing','pages.account.invoice','pages.account.security','pages.account.settings','pages.charts',
'pages.notifications','pages.pricing-page','pages.profile.overview','pages.profile.projects','pages.profile.teams',
'pages.projects.general','pages.projects.new-project','pages.projects.timeline','pages.rtl-page','pages.sweet-alerts',
'pages.users.new-user','pages.users.reports','pages.widgets','performance.ga4','performance.google-ads',
'performance.gsc','performance.meta-ads','performance.tiktok-ads','permissions.index','ppc-insights.index',
'products.index','profile.edit','profile.show','profitability.index','quick-insights.index',
'reports.index','roles.create','roles.index','roles.show','session.login',
'session.register','session.reset-password.resetPassword','session.reset-password.sendEmail','setup.index','user_type.auth',
'user_type.guest','users.create','users.index','users.show','datatables-export::export-button',
...
'VITE_APP_NAME','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','GOOGLE_ADS_API_ENDPOINT',
'GOOGLE_ADS_API_KEY','META_ADS_API_ENDPOINT','META_ADS_API_KEY','TIKTOK_ADS_API_ENDPOINT','TIKTOK_ADS_API_KEY',
'GA4_API_ENDPOINT','GA4_API_KEY',);
