@extends('user_type.auth', ['parentFolder' => 'authentication', 'childFolder' => 'verification', 'hasFooter' => 'false', 'navbar' => 'illustration'])
            ...
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-warning h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center">
                ...
                <div class="position-relative">
                  <img class="max-width-500 w-100 position-relative z-index-2" src="{{ URL::asset('assets/img/illustrations/danger-chat-ill.png') }}" alt="chart-ill">
                </div>
