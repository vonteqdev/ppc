@extends('user_type.auth', ['parentFolder' => 'authentication', 'childFolder' => 'lock', 'hasFooter' => 'footer', 'navbar' => 'basic'])
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card py-lg-3">
            <div class="card-body text-center">
              <div class="info mb-4">
                <img class="avatar avatar-xxl" alt="Image placeholder" src="{{ URL::asset('assets/img/team-4.jpg') }}">
              </div>
