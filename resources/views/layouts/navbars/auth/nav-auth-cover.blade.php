<div class="container position-sticky z-index-sticky top-0">
    <div class="row">
        ...
        <nav class="navbar navbar-expand-lg  blur blur-rounded top-0  z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
            ...
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="/dashboard-default">
                Soft UI Dashboard PRO Laraveladsa
            </a>
            ...
            <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                ...
                <li class="nav-item dropdown dropdown-hover mx-2">
                    ...
                    Pages
                    <img src=" {{ URL::asset('assets/img/down-arrow-dark.svg') }}" alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
                    <img src="{{ URL::asset('assets/img/down-arrow-dark.svg') }}" alt="down-arrow" class="arrow ms-1 d-lg-none d-block">
                    </a>
                    ...
                    <div class="row d-none d-lg-block">
                        ...
                        <div class="row">
                            ...
                            <a href="/dashboard-default" class="dropdown-item border-radius-md">
                            ...
                            <a href="/dashboard-crm" class="dropdown-item border-radius-md">
                            ...
                            <a href="/pages-users-new" class="dropdown-item border-radius-md">
                            ...
                            <a href="/pages-pricing" class="dropdown-item border-radius-md">
                                <span class="ps-3">Pricing Page</span>
                            </a>
                            <a href="/pages-rtl" class="dropdown-item border-radius-md">
                ...
                <li class="nav-item dropdown dropdown-hover mx-2">
                    ...
                    <div class="row d-none d-lg-flex">
                        ...
                        <ul class="list-group">
                            ...
                            <a class="dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between mb-1" id="dropdownSignIn">
                                <span>Sign In</span>
                                <img src="{{ URL::asset('assets/img/down-arrow.svg') }}" alt="down-arrow" class="arrow">
                            </a>
                            ...
                            <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownError">
                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/authentication-error404">
                                <span>404</span>
                                </a>
                                <a class="dropdown-item ps-3 border-radius-md mb-1" href="/authentication-error500">
                                <span>500</span>
                                </a>
                            </div>
                            </li>
                    ...
                    <div class="row d-lg-none">
                        ...
                        <a href="/authentication-error404" class="dropdown-item border-radius-md">
                            404
                        </a>
                        <a href="/authentication-error500" class="dropdown-item border-radius-md">
                            500
                        </a>
                        </div>
                    </div>
                ...
                <li class="nav-item dropdown dropdown-hover mx-2">
                    ...
                    <div class="d-none d-lg-block">
                        <ul class="list-group">
                        <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                            <a class="dropdown-item py-2 ps-3 border-radius-md" href="/kanban">
                            <div class="d-flex">
                        ...
                        <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                            <a class="dropdown-item py-2 ps-3 border-radius-md" href="/wizard">
                            <div class="d-flex">
                                <div class="icon h-10 me-3 d-flex mt-1">
                        ...
                        <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                            <a class="dropdown-item py-2 ps-3 border-radius-md" href="/datatable">
                            <div class="d-flex">
                                <div class="icon h-10 me-3 d-flex mt-1">
                        ...
                        <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                            <a class="dropdown-item py-2 ps-3 border-radius-md" href="/calendar">
                            <div class="d-flex">
                                <div class="icon h-10 me-3 d-flex mt-1">
                    ...
                    <div class="row d-lg-none">
                        <div class="col-md-12">
                        <a class="py-2 ps-3 border-radius-md" href="/kanban">
                            <div class="d-flex">
                            <div class="icon h-10 me-3 d-flex mt-1">
                                <i class="ni ni-single-copy-04 text-gradient text-primary"></i>
                            </div>
                        ...
                        <a class="py-2 ps-3 border-radius-md" href="/wizard">
                            <div class="d-flex">
                            <div class="icon h-10 me-3 d-flex mt-1">
                                <i class="ni ni-laptop text-gradient text-primary"></i>
                            </div>
                        ...
                        <a class="py-2 ps-3 border-radius-md" href="/datatable">
                            <div class="d-flex">
                            <div class="icon h-10 me-3 d-flex mt-1">
                                <i class="ni ni-badge text-gradient text-primary"></i>
                            </div>
                        ...
                        <a class="py-2 ps-3 border-radius-md" href="/calendar">
                            <div class="d-flex">
                            <div class="icon h-10 me-3 d-flex mt-1">
                                <i class="ni ni-notification-70 text-gradient text-primary"></i>
                            </div>
                ...
                <li class="nav-item dropdown dropdown-hover mx-2">
                    ...
                    <div class="row d-none d-lg-block">
                        ...
                        <div class="row">
                            ...
                            <a href="/ecommerce-orders-details" class="dropdown-item border-radius-md">
                            ...
                            <a href="/ecommerce-products-page" class="dropdown-item border-radius-md">
                                <span class="ps-3">Product Page</span>
                            </a>
                            <a href="/ecommerce-products-list" class="dropdown-item border-radius-md">
