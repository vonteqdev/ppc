...
<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3  navbar-transparent mt-4">
    <div class="container">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="/dashboard-default">
        ...
        <ul class="navbar-nav navbar-nav-hover mx-auto">
            ...
            <a role="button" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center " id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
                Pages
                <img src=" {{ URL::asset('assets/img/down-arrow-white.svg ') }}" alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
