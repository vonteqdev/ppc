...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="g-sidenav-show  bg-gray-100">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item dropdown pe-2 d-flex align-items-center">
                            <a href="javascript:;" class="nav-link text-body p-0 font-weight-bold" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <span class="d-sm-inline d-none">Hi, {{auth()->user()->first_name}}!</span>
                            </a>
                        ...
                        <li class="nav-item dropdown pe-2 d-flex align-items-center" style="margin-left: 4px">
        ...
        <script src="{{ URL::asset('assets/js/plugins/jquery/ui-1.13.2/jquery-ui.min.js') }}"></script>
        <script src="{{ URL::asset('assets/js/core/popper.min.js') }}"></script>
        <script src="{{ URL::asset('assets/js/core/bootstrap.min.js') }}"></script>
        <script src="{{ URL::asset('assets/js/plugins/cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js') }}"></script>
        <script src="{{ URL::asset('assets/js/plugins/cdn.datatables.net/1.10.19/js/dataTables.bootstrap4.min.js') }}"></script>
        ...
        <script src="{{ URL::asset('assets/js/plugins/sweetalert2/sweetalert2.all.min.js') }}"></script>
        ...
        <script>
            ...
            function disableButtonBeforeSendingRequest(buttonId){
                $('#'+buttonId).prop('disabled', true);
                $('#'+buttonId).html('<i class="fas fa-spinner fa-spin"></i> Loading...');
            }

            function enableButtonAfterGettingResponse(buttonId,buttonText){
                $('#'+buttonId).prop('disabled', false);
                $('#'+buttonId).html(buttonText);
            }

            const notifyTemplateString =
                `
                    <div data-notify="container" class="col-xs-2 col-sm-6 col-md-4 col-xl-3 alert alert-{0} d-flex align-items-center" role="alert">
                        <div class="d-flex align-items-center position-relative notify-dismiss-wrapper" data-notify="dismiss">
                            <button type="button" title="close notification" class="close"></button>
                            <div class="pr-3">
                            ...
                            <div>
                                ...
                                <a href="{3}" title="notification text" target="{4}" data-notify="url"></a>
                            </div>
                        </div>
                    </div>
                `;

            const notificationDangerOptions = {
                type: 'danger notify-outline',
                newest_on_top: true,
                allow_dismiss: true,
                placement: {
                    align: 'center'
                ...
                delay: 4000,
                z_index: 9999,
                template: notifyTemplateString,
            };
            const notificationSuccessOptions = {
                type: 'success notify-outline',
                newest_on_top: true,
                allow_dismiss: true,
                placement: {
                    align: 'center'
