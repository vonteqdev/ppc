@extends('user_type.auth', ['parentFolder' => 'ecommerce', 'childFolder' => 'none'])
                ...
                <div class="d-flex align-items-center">
                  <div class="form-group w-70">
                    <div class="input-group bg-gray-200">
                      <input class="form-control form-control-sm" value="soft-ui-dashboard-vmsk392" type="text" disabled>
                      <span class="input-group-text bg-transparent" data-bs-toggle="tooltip" data-bs-placement="top" title="Referral code expires in 24 hours"><i class="ni ni-key-25"></i></span>
                    </div>
                  </div>
              ...
              <div class="card border-dashed border-1 text-center h-100">
                <div class="card-body position-relative z-index-1 d-flex flex-column">
                  <div class="position-relative d-flex align-items-center justify-content-center h-100">
                    <img class="w-50 position-relative z-index-2" src="{{ URL::asset('assets/img/illustrations/rocket-white.png') }}" alt="illustration">
                  </div>
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="d-flex px-3 py-1">
                      <div>
                        <img src="{{ URL::asset('assets/img/team-1.jpg') }}" class="avatar me-3" alt="avatar image">
                      </div>
                  ...
                  <td class="align-middle text-end">
                    <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                      ...
                      <button type="button" class="btn btn-sm btn-icon-only btn-rounded btn-outline-secondary mb-0 ms-2 btn-sm d-flex align-items-center justify-content-center ms-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Refund rate is lower with 97% than other users">
                ...
                <tr>
                  <td>
                    <div class="d-flex px-3 py-1">
                      <div>
                        <img src="{{ URL::asset('assets/img/team-2.jpg') }}" class="avatar me-3" alt="avatar image">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                ...
                <tr>
                  <td>
                    <div class="d-flex px-3 py-1">
                      <div>
                        <img src="{{ URL::asset('assets/img/team-3.jpg') }}" class="avatar me-3" alt="avatar image">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                ...
                <tr>
                  <td>
                    <div class="d-flex px-3 py-1">
                      <div>
                        <img src="{{ URL::asset('assets/img/team-4.jpg') }}" class="avatar me-3" alt="avatar image">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                ...
                <tr>
                  <td>
                    <div class="d-flex px-3 py-1">
                      <div>
                        <img src="{{ URL::asset('assets/img/team-5.jpg') }}" class="avatar me-3" alt="avatar image">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                  ...
                  <td class="align-middle text-end">
                    <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                      ...
                      <i class="ni ni-bold-up text-sm ms-1 mt-1 text-danger"></i>
                      <button type="button" class="btn btn-sm btn-icon-only btn-rounded btn-outline-secondary mb-0 ms-2 btn-sm d-flex align-items-center justify-content-center ms-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Refund rate is higher with 70% than other users">
                        <i class="fas fa-info" aria-hidden="true"></i>
                      </button>
                    </div>
                  </td>
