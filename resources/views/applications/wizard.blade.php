                  ...
                  <div class="row mt-3">
                    <div class="col-12 col-sm-4">
                      <div class="avatar avatar-xxl position-relative">
                        <img src="{{ URL::asset('assets/img/team-2.jpg') }}" class="border-radius-md" alt="team-2">
                    ...
                    <div class="col-12 col-sm-8 mt-4 mt-sm-0 text-start">
                      ...
                      <input class="multisteps-form__input form-control mb-3" type="text" placeholder="Eg. Michael" aria-required="true"/>
