                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ URL::asset('assets/img/small-logos/logo-xd.svg') }}" class="avatar avatar-sm me-2" alt="logo_xd">
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ URL::asset('assets/img/small-logos/logo-atlassian.svg') }}" class="avatar avatar-sm me-2" alt="logo_atlassian">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ URL::asset('assets/img/small-logos/logo-slack.svg') }}" class="avatar avatar-sm me-2" alt="logo_slack">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ URL::asset('assets/img/small-logos/logo-spotify.svg') }}" class="avatar avatar-sm me-2" alt="logo_spotify">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{ URL::asset('assets/img/small-logos/logo-jira.svg') }}" class="avatar avatar-sm me-2" alt="logo_jira">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
