<li class="nav-item mt-3">
    <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Performance</h6>
</li>
<li class="nav-item">
    <a class="nav-link {{ request()->routeIs('account') ? 'active' : '' }}" href="{{route('dashboard')}}">
        ...
        <span class="nav-link-text ms-1">Google Ads</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link {{ request()->routeIs('account') ? 'active' : '' }}" href="{{route('dashboard')}}">
        ...
        <span class="nav-link-text ms-1">Facebook Ads</span>
    </a>
</li>