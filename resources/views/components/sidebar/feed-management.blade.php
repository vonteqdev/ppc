...
<li class="nav-item">
    <a data-bs-toggle="collapse" href="#feedsExtend" class="nav-link {{ request()->routeIs(['users.*']) ? 'active' : '' }}" aria-controls="feedsExtend" role="button" aria-expanded="{{ request()->routeIs(['users.*']) ? 'true' : 'false' }}">
    ...
    <div class="collapse {{ request()->routeIs(['users.*', 'roles.*']) ? 'show' : '' }}" id="feedsExtend">
