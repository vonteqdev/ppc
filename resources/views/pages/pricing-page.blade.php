...
@section('content')
  <div class="page-header bg-gradient-primary  position-relative m-3 border-radius-xl">
    <img src="{{ URL::asset('assets/img/shapes/waves-white.svg') }}" alt="pattern-lines" class="position-absolute opacity-6 start-0 top-0 w-100">
  ...
  <div class="container my-6">
    ...
    <div class="row mt-4">
      <div class="col-lg-2 col-md-4 col-6 mb-4">
        <img class="w-100 opacity-9" src="{{ URL::asset('assets/img/logos/gray-logos/logo-coinbase.svg') }}" alt="logo_coinbase">
      </div>
      <div class="col-lg-2 col-md-4 col-6 mb-4">
        <img class="w-100 opacity-9" src="{{ URL::asset('assets/img/logos/gray-logos/logo-nasa.svg') }}" alt="logo_nasa">
      </div>
      <div class="col-lg-2 col-md-4 col-6 mb-4">
        <img class="w-100 opacity-9" src="{{ URL::asset('assets/img/logos/gray-logos/logo-netflix.svg') }}" alt="logo_netflix">
      </div>
      <div class="col-lg-2 col-md-4 col-6 mb-4">
        <img class="w-100 opacity-9" src="{{ URL::asset('assets/img/logos/gray-logos/logo-pinterest.svg') }}" alt="logo_pinterest">
      </div>
      <div class="col-lg-2 col-md-4 col-6 mb-4">
        <img class="w-100 opacity-9" src="{{ URL::asset('assets/img/logos/gray-logos/logo-spotify.svg') }}" alt="logo_spotify">
      </div>
      <div class="col-lg-2 col-md-4 col-6 mb-4">
        <img class="w-100 opacity-9" src="{{ URL::asset('assets/img/logos/gray-logos/logo-vodafone.svg') }}" alt="logo_vodafone">
      </div>
    </div>
    <div class="row mt-8">
      <div class="col-md-6 mx-auto text-center">
