@extends('user_type.auth', ['parentFolder' => 'pages', 'childFolder' => 'users'])
            ...
            <tbody>
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    <div>
                      <img src="{{ URL::asset('assets/img/team-2.jpg') }}" class="avatar avatar-sm me-3" alt="avatar image">
                    </div>
              ...
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    <div>
                      <img src="{{ URL::asset('assets/img/team-3.jpg') }}" class="avatar avatar-sm me-3" alt="avatar image">
                    </div>
                    <div class="d-flex flex-column justify-content-center">
              ...
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    <div>
                      <img src="{{ URL::asset('assets/img/team-4.jpg') }}" class="avatar avatar-sm me-3" alt="avatar image">
                    </div>
                    <div class="d-flex flex-column justify-content-center">
