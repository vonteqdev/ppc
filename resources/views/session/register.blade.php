                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form action="/register" method="POST" role="form text-start">
                                ...
                                <div>
                                    <div class=" ">
                                        <input type="text" class="form-control " placeholder="Name" aria-label="Name" aria-describedby="email-addon" name="name" id="name" value="{{ old('name') }}" required>
                                        @error('name')
                                ...
                                <div class="mt-3">
                                    <div class=" ">
                                        <input type="email" class="form-control " placeholder="Email" aria-label="Email" aria-describedby="email-addon" name="email" id="email" value="{{ old('email') }}" required>
                                        @error('email')
                                            <p class="text-danger text-xs mt-2 mb-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="mt-3">
                                    <div class=" ">
                                        <select class="form-control" name="role_id" id="role_id" name="user_type">
                                ...
                                <div class="mt-3">
                                    <div class=" ">
                                        <input type="password" class="form-control " placeholder="Password" aria-label="Password" aria-describedby="password-addon" name="password" id="password" required>
                                        @error('password')
                                            <p class="text-danger text-xs mt-2 mb-2">{{ $message }}</p>
                                        @enderror
                                    </div>
